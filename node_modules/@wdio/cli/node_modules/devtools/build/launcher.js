...
const DEVICE_NAMES = Object.keys(puppeteer_core_1.KnownDevices);
/**
...
async function launchChrome(capabilities) {
    ...
    if (typeof mobileEmulation.deviceName === 'string') {
        const deviceProperties = puppeteer_core_1.KnownDevices[mobileEmulation.deviceName];
        if (!deviceProperties) {
...
async function launch(capabilities) {
    var _a;
    puppeteer_core_1.Puppeteer.unregisterCustomQueryHandler('shadow');
    puppeteer_core_1.Puppeteer.registerCustomQueryHandler('shadow', puppeteer_1.QueryHandler);
